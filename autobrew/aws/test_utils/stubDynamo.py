...
from autobrew.aws.measurements.measurementServiceRemote import MEASUREMENT_SERIES_DYNAMO_TABLE
from autobrew.aws.brew.brewServiceRemote import BREWS_DYNAMO_TABLE, BREW_TABLE_ID
